...
module.exports = class GoogleCloudRunService{
    ...
    async deployContainerService({name, containerImageUrl, consistantCpuAllocation, minInstances, maxInstances, port, commands, args, 
        ...
        const result = {createService: (await runApi.projects.locations.services.create({
