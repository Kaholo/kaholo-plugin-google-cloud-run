...
async function deployContainerService(action, settings){
    const { name, containerImageUrl, consistantCpuAllocation, minInstances, maxInstances, port, commands, args, memory, cpuCount, 
        timeout, maxConcurrency, execEnv, envVariables, serviceAccount, ingressRules, dontRequireAuthentication } = action.params;
